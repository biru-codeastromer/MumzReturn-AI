...
ACTION_REASONING_AR = {
    "REFUND": "الرسالة تشير إلى أن {evidence}، وهذا يطابق قواعد الاسترجاع المالي.",
    "EXCHANGE": "الرسالة تشير إلى أن {evidence}، وهذا يطابق قواعد الاستبدال.",
    "STORE_CREDIT": "الرسالة تشير إلى أن {evidence}، وهذا يطابق حالات رصيد المتجر.",
    "ESCALATE": "الرسالة تشير إلى أن {evidence}، لذلك لازم تتحول للتصعيد بدل التوجيه التلقائي.",
}
